...
# prep data ------------------
sub_models_resp   <- c("m_adj_phq_2023_gam_sub_sleep",
                       "m_adj_gad_2023_gam_sub_sleep"
)
...
# 
# plot_adj_24h_phq_2023_99ci <- foreach(i = seq_len(nrow(rg_phq)),
...
#                              }
# 
# names(plot_adj_24h_phq_2023_99ci) <- foreach(i = seq_len(nrow(rg_phq))) %dopar% {
#   paste0("Reallocation of Time between ", rg_phq[i, "parts"], " and ", rg_phq[i, "phq"])
# }
# plot_adj_24h_phq_2023_99ci
# 
# saveRDS(plot_adj_24h_phq_2023_99ci, paste0(outputdir, "plot_adj_24h_phq_2023_99ci", ".RDS"))
# 
# grDevices::cairo_pdf(
#   file = paste0(outputdir, "plot_adj_24h_phq_2023_99ci", ".pdf"),
#   width = 9,
#   height = 12,
# )
# 
# figure <- ggarrange(plot_adj_24h_phq_2023_99ci[[1]], plot_adj_24h_phq_2023_99ci[[2]], 
#                     plot_adj_24h_phq_2023_99ci[[3]], plot_adj_24h_phq_2023_99ci[[4]], 
#                     nrow = 4,
#                     common.legend = TRUE,
#                     legend   = "bottom"
# )
...
rg_gad <- expand.grid.df(data.frame(sub_models_gad, gad),
                         data.frame(parts, part_labels))
# 
# plot_adj_24h_gad_2023_99ci <- foreach(i = seq_len(nrow(rg_gad)),
#                              .packages = "multilevelcoda") %dopar% {
#                                
...
#                              }
# 
# names(plot_adj_24h_gad_2023_99ci) <- foreach(i = seq_len(nrow(rg_gad))) %dopar% {
#   paste0("Reallocation of Time between ", rg_gad[i, "parts"], " and ", rg_gad[i, "gad"])
# }
# plot_adj_24h_gad_2023_99ci
# 
# saveRDS(plot_adj_24h_gad_2023_99ci, paste0(outputdir, "plot_adj_24h_gad_2023_99ci", ".RDS"))
# 
# grDevices::cairo_pdf(
#   file = paste0(outputdir, "plot_adj_24h_gad_2023_99ci", ".pdf"),
#   width = 9,
#   height = 12,
# )
# 
# figure <- ggarrange(plot_adj_24h_gad_2023_99ci[[1]], plot_adj_24h_gad_2023_99ci[[2]], 
#                     plot_adj_24h_gad_2023_99ci[[3]], plot_adj_24h_gad_2023_99ci[[4]], 
#                     nrow = 4,
#                     common.legend = TRUE,
#                     legend   = "bottom"
# )
...
# phq
plot_adj_phq_24h_2023_99ci_exp <- foreach(i = seq_len(nrow(rg_phq_exp)),
                                          .packages = "multilevelcoda") %dopar% {
...
names(plot_adj_phq_24h_2023_99ci_exp) <- foreach(i = seq_len(nrow(rg_phq_exp))) %dopar% {
  paste0("Reallocation from ", rg_phq_exp[i, "parts"], " to ",  rg_phq_exp[i, "to"], " and ", rg_phq_exp[i, "phq"])
}

# gad
plot_adj_gad_24h_2023_99ci_exp <- foreach(i = seq_len(nrow(rg_gad_exp)),
                                          .packages = "multilevelcoda") %dopar% {
...
names(plot_adj_gad_24h_2023_99ci_exp) <- foreach(i = seq_len(nrow(rg_gad_exp))) %dopar% {
  paste0("Reallocation from ", rg_gad_exp[i, "parts"], " to ",  rg_gad_exp[i, "to"], " and ", rg_gad_exp[i, "gad"])
}

## patch ------
# separate for dep and anx
p5 <- plot_adj_phq_24h_2023_99ci_exp[[2]] + plot_adj_phq_24h_2023_99ci_exp[[3]]  + plot_adj_phq_24h_2023_99ci_exp[[12]] + plot_layout(guides = "collect", ncol = 3) & theme(legend.position = "none")
p6 <- plot_adj_phq_24h_2023_99ci_exp[[8]] + plot_adj_phq_24h_2023_99ci_exp[[11]] + plot_adj_phq_24h_2023_99ci_exp[[1]] + plot_layout(guides = "collect", ncol = 3) & theme(legend.position = "none")

p7 <- plot_adj_gad_24h_2023_99ci_exp[[2]] + plot_adj_gad_24h_2023_99ci_exp[[3]]  + plot_adj_gad_24h_2023_99ci_exp[[12]] + plot_layout(guides = "collect", ncol = 3) & theme(legend.position = "none")
p8 <- plot_adj_gad_24h_2023_99ci_exp[[8]] + plot_adj_gad_24h_2023_99ci_exp[[11]] + plot_adj_gad_24h_2023_99ci_exp[[1]] + plot_layout(guides = "collect", ncol = 3) & theme(legend.position = "none")
...
grDevices::png(
  file = paste0(outputdir, "plot_adj_24h_phq_2023_99ci", ".png"),
  width = 8000,
  height = 5500,
  res = 900
)
...
grDevices::png(
  file = paste0(outputdir, "plot_adj_24h_gad_2023_99ci", ".png"),
  width = 8000,
  height = 5500,
  res = 900
)
...
grDevices::cairo_pdf(
  file = paste0(outputdir, "plot_adj_24h_phq_gad_2023_99ci", ".pdf"),
  width = 8,
  height = 11,
)
...
grDevices::png(
  file = paste0(outputdir, "plot_adj_24h_phq_gad_2023_99ci", ".png"),
  width = 8000,
  height = 11000,
  res = 900
)
...
## mild and persistent -------
sub_models_resp   <- c("m_adj_phq_2023_gam_sub_sleep", "m_adj_gad_2023_gam_sub_sleep")
...
plot_adj_24h_phq_by_sleep_period_insomnia3_2023_99ci <- foreach(i = seq_along(parts),
                                                               .packages = "multilevelcoda") %dopar% {
...
plot_adj_24h_phq_by_sleep_period_insomnia3_2023_99ci[[1]] / plot_adj_24h_phq_by_sleep_period_insomnia3_2023_99ci[[2]] / plot_adj_24h_phq_by_sleep_period_insomnia3_2023_99ci[[3]] / plot_adj_24h_phq_by_sleep_period_insomnia3_2023_99ci[[4]]  + 
  plot_layout(guides = "collect") & theme(legend.position = "bottom")

grDevices::cairo_pdf(
  file = paste0(outputdir, "plot_adj_24h_phq_by_sleep_period_insomnia3_2023_99ci", ".pdf"),
  width = 9,
  height = 12,
)
...
figure <- ggarrange(plot_adj_24h_phq_by_sleep_period_insomnia3_2023_99ci[[1]], plot_adj_24h_phq_by_sleep_period_insomnia3_2023_99ci[[2]], 
                    plot_adj_24h_phq_by_sleep_period_insomnia3_2023_99ci[[3]], plot_adj_24h_phq_by_sleep_period_insomnia3_2023_99ci[[4]], 
                    nrow = 4,
                    common.legend = TRUE,
                    legend   = "bottom"
)
...
grDevices::png(
  file = paste0(outputdir, "plot_adj_24h_phq_by_sleep_period_insomnia3_2023_99ci", ".png"),
  width = 9000,
  height = 12000,
  res = 900
)
...
plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci <- foreach(i = seq_along(parts),
                                                               .packages = "multilevelcoda") %dopar% {
...
plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci[[1]]

plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci[[1]] / plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci[[2]] / plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci[[3]] / plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci[[4]]  + 
  plot_layout(guides = "collect") & theme(legend.position = "bottom")

grDevices::cairo_pdf(
  file = paste0(outputdir, "plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci", ".pdf"),
  width = 9,
  height = 12,
)

figure <- ggarrange(plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci[[1]], plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci[[2]], 
                    plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci[[3]], plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci[[4]], 
                    nrow = 4,
                    common.legend = TRUE,
                    legend   = "bottom"
)
...
grDevices::png(
  file = paste0(outputdir, "plot_adj_24h_gad_by_sleep_period_insomnia3_2023_99ci", ".png"),
  width = 9000,
  height = 12000,
  res = 900
)
...
## final phq by insomnia ----------
plot_adj_24h_phq_by_sleep_period_insomnia2_2023_99ci <- foreach(i = seq_along(parts),
                                                               .packages = "multilevelcoda") %dopar% {
...
plot_adj_24h_phq_by_sleep_period_insomnia2_2023_99ci[[1]] / plot_adj_24h_phq_by_sleep_period_insomnia2_2023_99ci[[2]] / plot_adj_24h_phq_by_sleep_period_insomnia2_2023_99ci[[3]] / plot_adj_24h_phq_by_sleep_period_insomnia2_2023_99ci[[4]]  + 
  plot_layout(guides = "collect") & theme(legend.position = "bottom")

grDevices::cairo_pdf(
  file = paste0(outputdir, "plot_adj_24h_phq_by_sleep_period_insomnia2_2023_99ci", ".pdf"),
  width = 9,
  height = 12,
)
...
figure <- ggarrange(plot_adj_24h_phq_by_sleep_period_insomnia2_2023_99ci[[1]], plot_adj_24h_phq_by_sleep_period_insomnia2_2023_99ci[[2]], 
                    plot_adj_24h_phq_by_sleep_period_insomnia2_2023_99ci[[3]], plot_adj_24h_phq_by_sleep_period_insomnia2_2023_99ci[[4]], 
                    nrow = 4,
                    common.legend = TRUE,
                    legend   = "bottom"
)
...
grDevices::png(
  file = paste0(outputdir, "plot_adj_24h_phq_by_sleep_period_insomnia2_2023_99ci", ".png"),
  width = 9000,
  height = 12000,
  res = 900
)
...
## final gad by insomnia ----------
plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci <- foreach(i = seq_along(parts),
                                                               .packages = "multilevelcoda") %dopar% {
...
plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci[[1]]

plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci[[1]] / plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci[[2]] / plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci[[3]] / plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci[[4]]  + 
  plot_layout(guides = "collect") & theme(legend.position = "bottom")

grDevices::cairo_pdf(
  file = paste0(outputdir, "plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci", ".pdf"),
  width = 9,
  height = 12,
)

figure <- ggarrange(plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci[[1]], plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci[[2]], 
                    plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci[[3]], plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci[[4]], 
                    nrow = 4,
                    common.legend = TRUE,
                    legend   = "bottom"
)
...
grDevices::png(
  file = paste0(outputdir, "plot_adj_24h_gad_by_sleep_period_insomnia2_2023_99ci", ".png"),
  width = 9000,
  height = 12000,
  res = 900
)
