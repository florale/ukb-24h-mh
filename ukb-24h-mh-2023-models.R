...
m_phq_2023_gam_sub_sleep_q1 <- substitution(
...
saveRDS(m_phq_2023_gam_sub_sleep_q1, paste0(outputdir, "m_phq_2023_gam_sub_sleep_q1", ".RDS"))

m_phq_2023_gam_sub_sleep_q2 <- substitution(
...
saveRDS(m_phq_2023_gam_sub_sleep_q2, paste0(outputdir, "m_phq_2023_gam_sub_sleep_q2", ".RDS"))

m_phq_2023_gam_sub_sleep_q3 <- substitution(
...
saveRDS(m_phq_2023_gam_sub_sleep_q3, paste0(outputdir, "m_phq_2023_gam_sub_sleep_q3", ".RDS"))

## stratified by insomnia ------------
m_phq_2023_gam_goodsleep <- brmcoda(clr_acc_mhq_2023_goodsleep,
                                    phq_2023 ~ 
                                      s(ilr1) + s(ilr2) + s(ilr3) +
                                      s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                      icd_any_at_acc,
...
m_phq_2023_gam_insomnia_mild <- brmcoda(clr_acc_mhq_2023_insomnia_mild,
                                        phq_2023 ~ 
                                          s(ilr1) + s(ilr2) + s(ilr3) +
                                          s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                          icd_any_at_acc,
...
m_phq_2023_gam_insomnia_persistent <- brmcoda(clr_acc_mhq_2023_sleep_insomnia_persistent,
                                              phq_2023 ~ 
                                                s(ilr1) + s(ilr2) + s(ilr3) +
                                                s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                icd_any_at_acc,
...
m_phq_2023_gam_sub_goodsleep <- substitution(
...
saveRDS(m_phq_2023_gam_sub_goodsleep, paste0(outputdir, "m_phq_2023_gam_sub_goodsleep", ".RDS"))

m_phq_2023_gam_sub_insomnia_mild <- substitution(
...
saveRDS(m_phq_2023_gam_sub_insomnia_mild, paste0(outputdir, "m_phq_2023_gam_sub_insomnia_mild", ".RDS"))

m_phq_2023_gam_sub_insomnia_persistent <- substitution(
...
saveRDS(m_phq_2023_gam_sub_insomnia_persistent, paste0(outputdir, "m_phq_2023_gam_sub_insomnia_persistent", ".RDS"))
...
m_phq_2023_gam_sub_goodsleep <- readRDS(paste0(outputdir, "m_phq_2023_gam_sub_goodsleep", ".RDS"))
m_phq_2023_gam_sub_insomnia_mild <- readRDS(paste0(outputdir, "m_phq_2023_gam_sub_insomnia_mild", ".RDS"))
m_phq_2023_gam_sub_insomnia_persistent <- readRDS(paste0(outputdir, "m_phq_2023_gam_sub_insomnia_persistent", ".RDS"))
...
summary(m_phq_2023_gam_sub_sleep_q1, delta = 20)
summary(m_phq_2023_gam_sub_sleep_q2, delta = 20)
summary(m_phq_2023_gam_sub_sleep_q3, delta = 20)

summary(m_phq_2023_gam_sub_goodsleep, delta = 20)
summary(m_phq_2023_gam_sub_insomnia_mild, delta = 20)
summary(m_phq_2023_gam_sub_insomnia_persistent, delta = 20)
...
m_gad_2023_gam_sub_sleep_q1 <- substitution(
...
saveRDS(m_gad_2023_gam_sub_sleep_q1, paste0(outputdir, "m_gad_2023_gam_sub_sleep_q1", ".RDS"))

m_gad_2023_gam_sub_sleep_q2 <- substitution(
...
saveRDS(m_gad_2023_gam_sub_sleep_q2, paste0(outputdir, "m_gad_2023_gam_sub_sleep_q2", ".RDS"))

m_gad_2023_gam_sub_sleep_q3 <- substitution(
...
saveRDS(m_gad_2023_gam_sub_sleep_q3, paste0(outputdir, "m_gad_2023_gam_sub_sleep_q3", ".RDS"))
...
m_gad_2023_gam_sub_sleep_q1_goodsleep <- substitution(
...
saveRDS(m_gad_2023_gam_sub_sleep_q1_goodsleep, paste0(outputdir, "m_gad_2023_gam_sub_sleep_q1_goodsleep", ".RDS"))

m_gad_2023_gam_sub_sleep_q2_goodsleep <- substitution(
...
saveRDS(m_gad_2023_gam_sub_sleep_q2_goodsleep, paste0(outputdir, "m_gad_2023_gam_sub_sleep_q2_goodsleep", ".RDS"))

m_gad_2023_gam_sub_sleep_q3_goodsleep <- substitution(
...
saveRDS(m_gad_2023_gam_sub_sleep_q3_goodsleep, paste0(outputdir, "m_gad_2023_gam_sub_sleep_q3_goodsleep", ".RDS"))
...
m_gad_2023_gam_sub_sleep_q1_insomnia_mild <- substitution(
...
saveRDS(m_gad_2023_gam_sub_sleep_q1_insomnia_mild, paste0(outputdir, "m_gad_2023_gam_sub_sleep_q1_insomnia_mild", ".RDS"))

m_gad_2023_gam_sub_sleep_q2_insomnia_mild <- substitution(
...
saveRDS(m_gad_2023_gam_sub_sleep_q2_insomnia_mild, paste0(outputdir, "m_gad_2023_gam_sub_sleep_q2_insomnia_mild", ".RDS"))

m_gad_2023_gam_sub_sleep_q3_insomnia_mild <- substitution(
...
saveRDS(m_gad_2023_gam_sub_sleep_q3_insomnia_mild, paste0(outputdir, "m_gad_2023_gam_sub_sleep_q3_insomnia_mild", ".RDS"))
...
m_gad_2023_gam_sub_sleep_q1_insomnia_persistent <- substitution(
...
saveRDS(m_gad_2023_gam_sub_sleep_q2_insomnia_persistent, paste0(outputdir, "m_gad_2023_gam_sub_sleep_q2_insomnia_persistent", ".RDS"))

m_gad_2023_gam_sub_sleep_q3_insomnia_persistent <- substitution(
...
summary(m_gad_2023_gam_sub_sleep_q1, delta = 20)
summary(m_gad_2023_gam_sub_sleep_q2, delta = 20)
summary(m_gad_2023_gam_sub_sleep_q3, delta = 20)

summary(m_gad_2023_gam_sub_sleep_q1_goodsleep, delta = 20)
summary(m_gad_2023_gam_sub_sleep_q2_goodsleep, delta = 20)
summary(m_gad_2023_gam_sub_sleep_q3_goodsleep, delta = 20)

summary(m_gad_2023_gam_sub_sleep_q1_insomnia_mild, delta = 20)
summary(m_gad_2023_gam_sub_sleep_q2_insomnia_mild, delta = 20)
summary(m_gad_2023_gam_sub_sleep_q3_insomnia_mild, delta = 20)
...
summary(m_gad_2023_gam_sub_sleep_q1_insomnia_persistent, delta = 20)
summary(m_gad_2023_gam_sub_sleep_q2_insomnia_persistent, delta = 20)
summary(m_gad_2023_gam_sub_sleep_q3_insomnia_persistent, delta = 20)

# phq8 -------------------
## quantile - good sleep -----------------------
m_phq8_2023_gam_sleep_q1_goodsleep <- brmcoda(clr_acc_mhq_2023_sleep_q1_goodsleep,
                                              phq8_2023 ~ 
                                                s(ilr1) + s(ilr2) + s(ilr3) +
                                                s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                icd_any_at_acc,
...
m_phq8_2023_gam_sleep_q2_goodsleep <- brmcoda(clr_acc_mhq_2023_sleep_q2_goodsleep,
                                              phq8_2023 ~ 
                                                s(ilr1) + s(ilr2) + s(ilr3) +
                                                s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                icd_any_at_acc,
...
m_phq8_2023_gam_sleep_q3_goodsleep <- brmcoda(clr_acc_mhq_2023_sleep_q3_goodsleep,
                                              phq8_2023 ~ 
                                                s(ilr1) + s(ilr2) + s(ilr3) +
                                                s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                icd_any_at_acc,
...
## quantile - mild insomnia -----------------------
m_phq8_2023_gam_sleep_q1_insomnia_mild <- brmcoda(clr_acc_mhq_2023_sleep_q1_insomnia_mild,
                                                  phq8_2023 ~ 
                                                    s(ilr1) + s(ilr2) + s(ilr3) +
                                                    s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                    icd_any_at_acc,
...
m_phq8_2023_gam_sleep_q2_insomnia_mild <- brmcoda(clr_acc_mhq_2023_sleep_q2_insomnia_mild,
                                                  phq8_2023 ~ 
                                                    s(ilr1) + s(ilr2) + s(ilr3) +
                                                    s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                    icd_any_at_acc,
...
m_phq8_2023_gam_sleep_q3_insomnia_mild <- brmcoda(clr_acc_mhq_2023_sleep_q3_insomnia_mild,
                                                  phq8_2023 ~ 
                                                    s(ilr1) + s(ilr2) + s(ilr3) +
                                                    s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                    icd_any_at_acc,
...
## quantile - moderate insomnia -----------------------
m_phq8_2023_gam_sleep_q1_insomnia_moderate <- brmcoda(clr_acc_mhq_2023_sleep_q1_insomnia_moderate,
                                                      phq8_2023 ~ 
                                                        s(ilr1) + s(ilr2) + s(ilr3) +
                                                        s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                        icd_any_at_acc,
...
m_phq8_2023_gam_sleep_q2_insomnia_moderate <- brmcoda(clr_acc_mhq_2023_sleep_q2_insomnia_moderate,
                                                      phq8_2023 ~ 
                                                        s(ilr1) + s(ilr2) + s(ilr3) +
                                                        s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                        icd_any_at_acc,
...
m_phq8_2023_gam_sleep_q3_insomnia_moderate <- brmcoda(clr_acc_mhq_2023_sleep_q3_insomnia_moderate,
                                                      phq8_2023 ~ 
                                                        s(ilr1) + s(ilr2) + s(ilr3) +
                                                        s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                        icd_any_at_acc,
...
## quantile - severe insomnia -----------------------
m_phq8_2023_gam_sleep_q1_insomnia_severe <- brmcoda(clr_acc_mhq_2023_sleep_q1_insomnia_severe,
                                                    phq8_2023 ~ 
                                                      s(ilr1) + s(ilr2) + s(ilr3) +
                                                      s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                      icd_any_at_acc,
...
m_phq8_2023_gam_sleep_q2_insomnia_severe <- brmcoda(clr_acc_mhq_2023_sleep_q2_insomnia_severe,
                                                    phq8_2023 ~ 
                                                      s(ilr1) + s(ilr2) + s(ilr3) +
                                                      s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                      icd_any_at_acc,
...
m_phq8_2023_gam_sleep_q3_insomnia_severe <- brmcoda(clr_acc_mhq_2023_sleep_q3_insomnia_severe,
                                                    phq8_2023 ~ 
                                                      s(ilr1) + s(ilr2) + s(ilr3) +
                                                      s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                      icd_any_at_acc,
...
## quantile - persistent insomnia -----------------------
m_phq8_2023_gam_sleep_q1_insomnia_persistent <- brmcoda(clr_acc_mhq_2023_sleep_q1_insomnia_persistent,
                                                        phq8_2023 ~ 
                                                          s(ilr1) + s(ilr2) + s(ilr3) +
                                                          s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                          icd_any_at_acc,
...
m_phq8_2023_gam_sleep_q2_insomnia_persistent <- brmcoda(clr_acc_mhq_2023_sleep_q2_insomnia_persistent,
                                                        phq8_2023 ~ 
                                                          s(ilr1) + s(ilr2) + s(ilr3) +
                                                          s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                          icd_any_at_acc,
...
m_phq8_2023_gam_sleep_q3_insomnia_persistent <- brmcoda(clr_acc_mhq_2023_sleep_q3_insomnia_persistent,
                                                        phq8_2023 ~ 
                                                          s(ilr1) + s(ilr2) + s(ilr3) +
                                                          s(age_at_acc) + sex + white + working + edu + never_smoked + current_drinker + s(deprivation) +
                                                          icd_any_at_acc,
