...
#               labs(
#                 # x = bquote(.(rg_phq_exp[i, "parts"]) %<-% phantom(o) %->%  .(rg_phq_exp[i, "to"])),
#                 y = paste0("Difference in ", rg_phq_exp[i, "phq"])) +
#               scale_x_continuous(limits = c(-33, 33),
#                                  breaks = c(-30, 0, 30),
#                                  labels = c(paste0("30min\n", rg_phq_exp[i, "parts"]), "0", paste0("30min\n", rg_phq_exp[i, "to"]))
...
plot_adj_24h_phq_by_sleep_period_insomnia <- foreach(i = seq_along(parts),
                                                                .packages = "multilevelcoda") %dopar% {
...
plot_adj_24h_phq_by_sleep_period_insomnia[[1]] / plot_adj_24h_phq_by_sleep_period_insomnia[[2]] / plot_adj_24h_phq_by_sleep_period_insomnia[[3]] / plot_adj_24h_phq_by_sleep_period_insomnia[[4]]  + 
...
grDevices::png(
  file = paste0(outputdir, "plot_adj_24h_phq_by_sleep_period_insomnia", ".png"),
  width = 9000,
  height = 12000,
  res = 900
)
...
plot_adj_24h_gad_by_sleep_period_insomnia <- foreach(i = seq_along(parts),
                                                                .packages = "multilevelcoda") %dopar% {
...
plot_adj_24h_gad_by_sleep_period_insomnia[[1]] / plot_adj_24h_gad_by_sleep_period_insomnia[[2]] / plot_adj_24h_gad_by_sleep_period_insomnia[[3]] / plot_adj_24h_gad_by_sleep_period_insomnia[[4]]  + 
  plot_layout(guides = "collect") & theme(legend.position = "bottom")

grDevices::cairo_pdf(
  file = paste0(outputdir, "plot_adj_24h_gad_by_sleep_period_insomnia", ".pdf"),
  width = 9,
  height = 12,
)
...
grDevices::png(
  file = paste0(outputdir, "plot_adj_24h_gad_by_sleep_period_insomnia", ".png"),
  width = 9000,
  height = 12000,
  res = 900
)
