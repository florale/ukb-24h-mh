...
sub_models_resp   <- c("m_phq_2016_gam_sub_sleep", "m_gad_2016_gam_sub_sleep")
...
### going with this -----------
phq_by_sleep_period_insomnia <- foreach(i = seq_along(parts),
                                        .packages = "multilevelcoda") %dopar% {
...
phq_by_sleep_period_insomnia

phq_by_sleep_period_insomnia[[1]] / phq_by_sleep_period_insomnia[[2]] / phq_by_sleep_period_insomnia[[3]] / phq_by_sleep_period_insomnia[[4]] + 
  plot_layout(guides = "collect") & theme(legend.position = "bottom")

grDevices::cairo_pdf(
  file = paste0(outputdir, "phq_by_sleep_period_insomnia", ".pdf"),
  width = 9,
  height = 12,
)
...
figure <- ggarrange(phq_by_sleep_period_insomnia[[1]], phq_by_sleep_period_insomnia[[2]], 
                    phq_by_sleep_period_insomnia[[3]], phq_by_sleep_period_insomnia[[4]], 
                    nrow = 4,
                    common.legend = TRUE,
                    legend   = "bottom"
)
...
## final plot ----------
gad_by_sleep_period_insomnia <- foreach(i = seq_along(parts),
                                        .packages = "multilevelcoda") %dopar% {
...
gad_by_sleep_period_insomnia[[1]] / gad_by_sleep_period_insomnia[[2]] / gad_by_sleep_period_insomnia[[3]] / gad_by_sleep_period_insomnia[[4]]  + 
  plot_layout(guides = "collect") & theme(legend.position = "bottom")

grDevices::cairo_pdf(
  file = paste0(outputdir, "gad_by_sleep_period_insomnia", ".pdf"),
  width = 9,
  height = 12,
)
...
figure <- ggarrange(gad_by_sleep_period_insomnia[[1]], gad_by_sleep_period_insomnia[[2]], 
                    gad_by_sleep_period_insomnia[[3]], gad_by_sleep_period_insomnia[[4]], 
                    nrow = 4,
                    common.legend = TRUE,
                    legend   = "bottom"
)
