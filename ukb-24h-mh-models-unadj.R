...
summary(m_unadj_phq_2023_gam_sub_sleep_q3_insomnia_bl_99ci, delta = 30, digits = 3)[, estimates := paste0(round(Mean, 2), " [", round(CI_low, 2), ", ", round(CI_high, 2), "]")][, .(From, To, estimates)]

summary(m_unadj_phq_2023_gam_sub_sleep_q1_goodsleep_bl_99ci, delta = 30, digits = 3)[, estimates := paste0(round(Mean, 2), " [", round(CI_low, 2), ", ", round(CI_high, 2), "]")][, .(From, To, estimates)]
...
summary(m_unadj_gad_2023_gam_sub_sleep_q1_goodsleep_bl_99ci, delta = 30, digits = 4)[, estimates := paste0(round(Mean, 2), " [", round(CI_low, 2), ", ", round(CI_high, 2), "]")][, .(From, To, estimates)]
summary(m_unadj_gad_2023_gam_sub_sleep_q2_goodsleep_bl_99ci, delta = 30, digits = 4)[, estimates := paste0(round(Mean, 2), " [", round(CI_low, 2), ", ", round(CI_high, 2), "]")][, .(From, To, estimates)]
summary(m_unadj_gad_2023_gam_sub_sleep_q3_goodsleep_bl_99ci, delta = 30, digits = 4)[, estimates := paste0(round(Mean, 2), " [", round(CI_low, 2), ", ", round(CI_high, 2), "]")][, .(From, To, estimates)]
