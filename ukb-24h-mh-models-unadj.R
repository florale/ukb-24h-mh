...
# baseline insomnia
summary(m_unadj_phq_2023_gam_sub_sleep_q1_goodsleep_bl_99ci, delta = 30)
summary(m_unadj_phq_2023_gam_sub_sleep_q2_goodsleep_bl_99ci, delta = 30)
summary(m_unadj_phq_2023_gam_sub_sleep_q3_goodsleep_bl_99ci, delta = 30)

summary(m_unadj_phq_2023_gam_sub_sleep_q1_insomnia_bl_99ci, delta = 30)
summary(m_unadj_phq_2023_gam_sub_sleep_q2_insomnia_bl_99ci, delta = 30)
summary(m_unadj_phq_2023_gam_sub_sleep_q3_insomnia_bl_99ci, delta = 30)
...
# baseline insomnia
summary(m_unadj_gad_2023_gam_sub_sleep_q1_insomnia_bl_99ci, delta = 30)
summary(m_unadj_gad_2023_gam_sub_sleep_q2_insomnia_bl_99ci, delta = 30)
summary(m_unadj_gad_2023_gam_sub_sleep_q3_insomnia_bl_99ci, delta = 30)

summary(m_unadj_gad_2023_gam_sub_sleep_q1_goodsleep_bl_99ci, delta = 30)
summary(m_unadj_gad_2023_gam_sub_sleep_q2_goodsleep_bl_99ci, delta = 30)
summary(m_unadj_gad_2023_gam_sub_sleep_q3_goodsleep_bl_99ci, delta = 30)

# standardised estimates
## by quantiles + insomnia
d_unadj_gad_2023_gam_sub_sleep_q1_goodsleep_bl_99ci <- as.data.table(summary(m_unadj_gad_2023_gam_sub_sleep_q1_goodsleep_bl_99ci, delta = 30, digits = "asis"))
d_unadj_gad_2023_gam_sub_sleep_q2_goodsleep_bl_99ci <- as.data.table(summary(m_unadj_gad_2023_gam_sub_sleep_q2_goodsleep_bl_99ci, delta = 30, digits = "asis"))
d_unadj_gad_2023_gam_sub_sleep_q3_goodsleep_bl_99ci <- as.data.table(summary(m_unadj_gad_2023_gam_sub_sleep_q3_goodsleep_bl_99ci, delta = 30, digits = "asis"))

d_unadj_gad_2023_gam_sub_sleep_q1_insomnia_bl_99ci <- as.data.table(summary(m_unadj_gad_2023_gam_sub_sleep_q1_insomnia_bl_99ci, delta = 30, digits = "asis"))
d_unadj_gad_2023_gam_sub_sleep_q2_insomnia_bl_99ci <- as.data.table(summary(m_unadj_gad_2023_gam_sub_sleep_q2_insomnia_bl_99ci, delta = 30, digits = "asis"))
d_unadj_gad_2023_gam_sub_sleep_q3_insomnia_bl_99ci <- as.data.table(summary(m_unadj_gad_2023_gam_sub_sleep_q3_insomnia_bl_99ci, delta = 30, digits = "asis"))
